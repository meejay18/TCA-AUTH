...
const verificationTemplate = (verifyLink, firstName) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="button-container">
                    <a href="${verifyLink}" class="button">Verify Link</a>
                </div>
                <p>If you did not request for a new verification on our platform, kindly ignore this email.</p>
                <p>Best regards,<br>Mr Digban</p>
            </div>
            <div class="footer">
                <p>&copy; ${new Date().getFullYear()} . All rights reserved.</p>
            </div>  
...
module.exports = { signUpTemplate, verificationTemplate, resetPasswordTemplate }
